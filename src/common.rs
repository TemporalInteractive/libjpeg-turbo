...
pub enum Subsamp {
    ...
    Unknown = ffi::TJSAMP_TJSAMP_UNKNOWN,
}

impl Subsamp {
    pub(crate) fn from_int(subsamp: libc::c_int) -> Result<Self> {
        Ok(match subsamp {
            ffi::TJSAMP_TJSAMP_444 => Self::None,
            ffi::TJSAMP_TJSAMP_422 => Self::Sub2x1,
            ffi::TJSAMP_TJSAMP_420 => Self::Sub2x2,
            ffi::TJSAMP_TJSAMP_GRAY => Self::Gray,
            ffi::TJSAMP_TJSAMP_440 => Self::Sub1x2,
            ffi::TJSAMP_TJSAMP_411 => Self::Sub4x1,
            ffi::TJSAMP_TJSAMP_441 => Self::Sub1x4,
            ffi::TJSAMP_TJSAMP_UNKNOWN => Self::Unknown,
...
pub enum Colorspace {
    ...
    YCbCr = ffi::TJCS_TJCS_YCbCr as u32,
    ...
    /// planar images.
    #[doc(alias = "TJCS_GRAY")]
    Gray = ffi::TJCS_TJCS_GRAY as u32,
    ...
    #[doc(alias = "TJCS_CMYK")]
    CMYK = ffi::TJCS_TJCS_CMYK as u32,
    ...
    #[doc(alias = "TJCS_YCCK")]
    YCCK = ffi::TJCS_TJCS_YCCK as u32,
}

impl Colorspace {
    pub(crate) fn from_int(colorspace: libc::c_int) -> Result<Colorspace> {
        Ok(match colorspace as libc::c_uint {
            ffi::TJCS_TJCS_RGB => Colorspace::RGB,
            ffi::TJCS_TJCS_YCbCr => Colorspace::YCbCr,
            ffi::TJCS_TJCS_GRAY => Colorspace::Gray,
            ffi::TJCS_TJCS_CMYK => Colorspace::CMYK,
            ffi::TJCS_TJCS_YCCK => Colorspace::YCCK,
